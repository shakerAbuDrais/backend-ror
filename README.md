...
### Front-end
[front-end](https://github.com/shakerAbuDrais/front-end-ror.git)


### Backend
[back-end](https://github.com/shakerAbuDrais/backend-ror.git)
...
```
  git clone https://github.com/shakerAbuDrais/backend-ror.git
  cd backend-ror
```
